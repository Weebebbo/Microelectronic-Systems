...
begin
   ...
   U3 : AOI21_X1 port map( B1 => k_1_j(1), B2 => i_k(0), A => i_k(1), ZN => n1)
                           ;
...
begin
   ...
   U2 : AOI21_X1 port map( B1 => k_1_j, B2 => i_k(0), A => i_k(1), ZN => n1);
...
architecture SYN_str of carry_generator_NBIT32_NBIT_PER_BLOCK4 is
   ...
   signal co_7_port, co_6_port, co_5_port, co_4_port, co_3_port, co_2_port, 
      co_1_port, co_0_port, p_31_port, p_30_port, p_29_port, p_28_port, 
      ...
      g_2_port, g_1_port, g_0_port, Big_G_1_0_port, i_k_tmp_1_16, i_k_tmp_0_16,
      i_k_tmp_1_17, i_k_tmp_0_17, k_1_j_tmp_1_15, k_1_j_tmp_0_15, i_k_tmp_1_18,
      i_k_tmp_0_18, k_1_j_tmp_1_16, k_1_j_tmp_0_16, i_k_tmp_1_19, i_k_tmp_0_19,
      ...
      i_k_tmp_0_34, i_k_tmp_1_35, i_k_tmp_0_35, n1, n2 : std_logic;
...
begin
   ...
   g12_2_3 : g_block_8 port map( i_k(1) => i_k_tmp_1_16, i_k(0) => i_k_tmp_0_16
                           , k_1_j => Big_G_1_0_port, Gij => co_0_port);
   ...
   g_node_3_7_11 : g_block_6 port map( i_k(1) => k_1_j_tmp_1_22, i_k(0) => 
                           k_1_j_tmp_0_22, k_1_j => co_1_port, Gij => co_2_port
                           );
   g_node_3_7_15 : g_block_5 port map( i_k(1) => i_k_tmp_1_29, i_k(0) => 
                           i_k_tmp_0_29, k_1_j => co_1_port, Gij => co_3_port);
   ...
   g_node_4_15_19 : g_block_4 port map( i_k(1) => k_1_j_tmp_1_23, i_k(0) => 
                           k_1_j_tmp_0_23, k_1_j => co_3_port, Gij => co_4_port
                           );
   g_node_4_15_23 : g_block_3 port map( i_k(1) => k_1_j_tmp_1_25, i_k(0) => 
                           k_1_j_tmp_0_25, k_1_j => co_3_port, Gij => co_5_port
                           );
   g_node_4_15_27 : g_block_2 port map( i_k(1) => i_k_tmp_1_34, i_k(0) => 
                           i_k_tmp_0_34, k_1_j => co_3_port, Gij => co_6_port);
   ...
   U2 : AOI21_X1 port map( B1 => p_0_port, B2 => cin, A => g_0_port, ZN => n2);
...
architecture SYN_str of P4_adder_NBIT32 is
   ...
   signal co_tmp_6_port, co_tmp_5_port, co_tmp_4_port, co_tmp_3_port, 
      ...
      b_tmp_1_port, b_tmp_0_port : std_logic;
...
begin
   ...
   sum_generation : sum_generator_NBIT32_NBlocks8 port map( a(31) => a(31), 
                           ...
                           co_tmp_0_port, cin(0) => cin, s(31) => s(31), s(30) 
                           ...
                           => s(1), s(0) => s(0));
   U33 : XOR2_X1 port map( A => cin, B => b(9), Z => b_tmp_9_port);
   U34 : XOR2_X1 port map( A => cin, B => b(8), Z => b_tmp_8_port);
   U35 : XOR2_X1 port map( A => cin, B => b(7), Z => b_tmp_7_port);
   U36 : XOR2_X1 port map( A => cin, B => b(6), Z => b_tmp_6_port);
   U37 : XOR2_X1 port map( A => cin, B => b(5), Z => b_tmp_5_port);
   U38 : XOR2_X1 port map( A => cin, B => b(4), Z => b_tmp_4_port);
   U39 : XOR2_X1 port map( A => cin, B => b(3), Z => b_tmp_3_port);
   U40 : XOR2_X1 port map( A => cin, B => b(31), Z => b_tmp_31_port);
   U41 : XOR2_X1 port map( A => cin, B => b(30), Z => b_tmp_30_port);
   U42 : XOR2_X1 port map( A => cin, B => b(2), Z => b_tmp_2_port);
   U43 : XOR2_X1 port map( A => cin, B => b(29), Z => b_tmp_29_port);
   U44 : XOR2_X1 port map( A => cin, B => b(28), Z => b_tmp_28_port);
   U45 : XOR2_X1 port map( A => cin, B => b(27), Z => b_tmp_27_port);
   U46 : XOR2_X1 port map( A => cin, B => b(26), Z => b_tmp_26_port);
   U47 : XOR2_X1 port map( A => cin, B => b(25), Z => b_tmp_25_port);
   U48 : XOR2_X1 port map( A => cin, B => b(24), Z => b_tmp_24_port);
   U49 : XOR2_X1 port map( A => cin, B => b(23), Z => b_tmp_23_port);
   U50 : XOR2_X1 port map( A => cin, B => b(22), Z => b_tmp_22_port);
   U51 : XOR2_X1 port map( A => cin, B => b(21), Z => b_tmp_21_port);
   U52 : XOR2_X1 port map( A => cin, B => b(20), Z => b_tmp_20_port);
   U53 : XOR2_X1 port map( A => cin, B => b(1), Z => b_tmp_1_port);
   U54 : XOR2_X1 port map( A => cin, B => b(19), Z => b_tmp_19_port);
   U55 : XOR2_X1 port map( A => cin, B => b(18), Z => b_tmp_18_port);
   U56 : XOR2_X1 port map( A => cin, B => b(17), Z => b_tmp_17_port);
   U57 : XOR2_X1 port map( A => cin, B => b(16), Z => b_tmp_16_port);
   U58 : XOR2_X1 port map( A => cin, B => b(15), Z => b_tmp_15_port);
   U59 : XOR2_X1 port map( A => cin, B => b(14), Z => b_tmp_14_port);
   U60 : XOR2_X1 port map( A => cin, B => b(13), Z => b_tmp_13_port);
   U61 : XOR2_X1 port map( A => cin, B => b(12), Z => b_tmp_12_port);
   U62 : XOR2_X1 port map( A => cin, B => b(11), Z => b_tmp_11_port);
   U63 : XOR2_X1 port map( A => cin, B => b(10), Z => b_tmp_10_port);
